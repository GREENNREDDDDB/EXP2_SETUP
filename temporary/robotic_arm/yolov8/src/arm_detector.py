...
def detect(model, d435):
    ...
    return results, depth_frames, depth_intrin, width, height, transformation_matrix, annotated_frame

def main(model, d435):
    results, depth_frames, depth_intrin, width, height, transformation_matrix, annotated_frame = detect(model, d435)
    # d435 = D435()
    # # Load a model
    # model = YOLO('/home/greenddb/Projects/IEEE_RAL_EXP2_SETUP/yolov8/runs/detect/ieee_ral_exp214/weights/best.pt')  # load a custom model
